...
import umg.analisisdesistemas1.com.modelo.ModeloInfoUsuario;
...
public class ControladorInfoEmpleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int opcion = 0;
        String cadenaJSON = "";
        ArrayList<infoEmpleado> infoUsuario = new ArrayList<infoEmpleado>();
        ...
        try {
            ...
            infoUsuario = modeloinfoUsuario.obtenerInfo(opcion);  //obtengo la lista de departamentos
            Gson gson = new Gson();
            cadenaJSON = gson.toJson(infoUsuario);
