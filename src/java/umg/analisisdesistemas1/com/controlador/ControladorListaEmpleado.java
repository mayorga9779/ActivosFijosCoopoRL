...
import umg.analisisdesistemas1.com.modelo.ModeloListaEmpleado;
 ...
 * @author Neon
 */
public class ControladorListaEmpleado extends HttpServlet {

    private ModeloListaEmpleado modeloListaEmpleado = null;
    ...
    public void init() throws ServletException {
        ...
        try {
            modeloListaEmpleado = new ModeloListaEmpleado(ds);
        } catch (Exception ex) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            listaEmpleados = modeloListaEmpleado.ObtenerEmpleados();
            Gson gson = new Gson();
